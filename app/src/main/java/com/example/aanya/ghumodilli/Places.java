...
public class Places {
    ...
    public static ArrayList<Place> getPlaces(){
        ...
        placeList.add(new Place(R.drawable.lodi_gardens,lodiGardens,0,"Lodi Gardens","6:00 AM - 7:30 PM",
                ...
                "https://en.wikipedia.org/wiki/Lodi_Garden","http://www.delhitourism.gov.in/delhitourism/tourist_place/lodi_tomb.jsp","https://www.google.com/culturalinstitute/beta/exhibit/QRUxWeZM",
                "01124640079"));
